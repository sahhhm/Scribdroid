...
public class GetCommands {
     ...
     *         light left, light center, light right... idx[5,6]: line left,
     *         line right... idx[7]: stall
     */
    public int[] getAll() {
        int[] temp;
        int numBytes = 11;
    ...
    /**
     * Returns the left, center, right obstacle values of the robot. Note: this
     * is a FLUKE command.
     * 
     * @return An integer array of size 3 containing left, center, right
     *         obstacle values
     */
