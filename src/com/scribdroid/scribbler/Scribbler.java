...
public class Scribbler {
    ...
    public Bitmap takePicture() {
        ...
        if (getCommands != null) 
        {
            ...
            for (int i = 0; i < h; i++) {
                for (int j = 0; j < w; j++){
                    if (j >= 3) {
                        vy = -1; vu = 2; y1v = -1; y1u = -3;
                        uy = -1; uv = -2; y2u = -1; y2v = -3;
                    } else {
                        vy = 1; vu = 2; y1v = 3; y1u = 1; 
                        uy = 1; uv = 2; y2u = 3; y2v = 1;
                    }
                    if ((j % 4) == 0) {
                        V = ba[i * w + j] & 0xff;
                        Y = ba[i * w + j + vy] & 0xff;
     ...
     * type of sensor. IR array has size 2; LIGHT array has size 3; LINE array
     * has size 2; STALL array has size 1;
     * 
