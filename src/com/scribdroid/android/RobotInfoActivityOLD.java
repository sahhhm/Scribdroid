...
public class RobotInfoActivityOLD extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] informations = getResources().getStringArray(
                R.array.information_array);
        setListAdapter(new ArrayAdapter<String>(this, R.layout.info_list_item,
                informations));
                ...
                if (appState.getScribbler().isConnected()) {
                    if (text.equals("IR_ALL")) {
                        ...
                        Toast.makeText(
                                ...
                                "IR LEFT: " + ir[0] + "\n" + "IR RIGHT: "
                                        + ir[1], Toast.LENGTH_SHORT).show();
                    } else if (text.equals("BATTERY")) {
                        Toast.makeText(
                                getApplicationContext(),
                                "BATTERY: "
                                        + appState.getScribbler().getBattery(),
                                Toast.LENGTH_SHORT).show();
                    } else if (text.equals("ROBOT_NAME")) {
                        Toast.makeText(getApplicationContext(),
                                "Name: " + appState.getScribbler().getName(),
                                Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(
                                ...
                                "OBSTACLE LEFT: " + obs[0] + "\n"
                                        ...
                                        + "OBSTACLE RIGHT: " + obs[2],
                                Toast.LENGTH_SHORT).show();
                    } else if (text.equals("ALL_SENSORS")) {
                        HashMap<String, int[]> h = appState.getScribbler()
                                .getAll();
                        Toast.makeText(
                                getApplicationContext(),
                                "IR LEFT: " + h.get("IR")[0] + ", IR RIGHT: "
                                        + h.get("IR")[1] + "\n"
                                        + "LIGHT LEFT: " + h.get("LIGHT")[0]
                                        + ", LIGHT CENTER: "
                                        + h.get("LIGHT")[1]
                                        + ", LIGHT RIGHT: "
                                        + h.get("LIGHT")[2] + "\n"
                                        + "LINE LEFT: " + h.get("LINE")[0]
                                        + ", LINE RIGHT: " + h.get("LINE")[1]
                                        + "\n" + "STALL: " + h.get("STALL")[0],
                                Toast.LENGTH_SHORT).show();
